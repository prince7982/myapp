            ...
            <div class="register-container">
                <form class="register-form" onSubmit={handleSubmit(mysubmit)}>
                    ...
                    <div class="input-group">
                        ...
                        {errors.pass?.type==="minLength" && <p className='text-warning'>minimun 4 characters required</p>}
                        {/* {errors.pass?.type==="maxLength" && <p className='text-success'>your password is strong too long</p>} */}
